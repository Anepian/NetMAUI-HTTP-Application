...
public partial class CambiarDatos_P : ContentPage
{
    ...
    private async void CambiarProductos()
    {
        try
        {
            if (IdEntry.Text != "" || !string.IsNullOrWhiteSpace(IdEntry.Text))
            {
                ...
                string apiUrl = "https://alexlupian.000webhostapp.com/APIS/UPDATE_P.php?Id=" + IdEntry.Text + "&Nombre=" + NombreEntry.Text + "&Descripcion=" + DescripcionEntry.Text + "&Cantidad=" + CantidadEntry.Text + "&PrecioCosto=" + PrecioCostoEntry.Text + "&Foto=" + FotoEntry.Text + "&PrecioVenta=" + PrecioVentaEntry.Text;
    ...
    private async void BuscarButton_Clicked(object sender, EventArgs e)
    {
        ...
        string apiUrl = $"https://alexlupian.000webhostapp.com/APIS/GET_P.php?Id={id}";
