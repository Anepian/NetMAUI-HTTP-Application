...
public partial class Registrar : ContentPage
{
	...
	{
        _ = LlamadaGetAsync("https://https://alexlupian.000webhostapp.com//APIS/POST_U.php?Nombre=" + NombreEntry.Text + "&Contrasena=" + ContraseñaEntry.Text + "&Direccion=" + DireccionEntry.Text+ "&Correo=" + CorreoEntry.Text+ "&Telefono=" + TelefonoEntry.Text+ "&Foto=" + FotoEntry.Text);
    }
 }