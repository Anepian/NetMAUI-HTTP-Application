...
public partial class CambiarDatos_U : ContentPage
{
    ...
    private async void CambiarUsuario()
    {
        try
        {
            ...
            string apiUrl = "https://alexlupian.000webhostapp.com/APIS/UPDATE_U.php?Id=" + VariablesGlobales.Id + "&Nombre=" +NombreEntry.Text + "&Direccion="+DireccionEntry.Text + "&Telefono=" + TelefonoEntry.Text +"&Correo=" +CorreoEntry.Text +"&Foto=" + FotoEntry.Text +"&Contrasena=" + ContraseñaEntry.Text;
