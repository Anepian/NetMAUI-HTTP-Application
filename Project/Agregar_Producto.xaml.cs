...
public partial class Agregar_Producto : ContentPage
{
	...
	{
        _ = LlamadaGetAsync("https://https://alexlupian.000webhostapp.com//APIS/POST.php?Nombre=" + NombreEntry.Text + "&Descripcion=" + DescripcionEntry.Text + "&Cantidad=" + CantidadEntry.Text + "&PrecioCosto=" + PrecioCostoEntry.Text + "&PrecioVenta=" + PrecioVentaEntry.Text + "&Foto=" + FotoEntry.Text);
    }
}